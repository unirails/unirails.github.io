...
// let stationListDisplay = document.getElementById("upStationList").innerHTML
...
for (let i = 0; i < shlStationCount; i++) {
  ...
  let announcementString = '<div class="form-group"><textarea class="form-control"rows="5" onclick="this.focus();this.select()" id="station-' + i + '" readonly>\ntellraw @a ["",{"text":"&bsol;n"},{"text":"----=[ ","bold":true,"color":"gold"},{"text":"' + SHL + '","color":"red"},{"text":" ]=----","bold":true,"color":"gold"},{"text":"&bsol;n"},{"text":"▽ ","color":"dark_gray"},{"text":"' + shlStations[i-1] + '","color":"dark_gray"},{"text":"&bsol;n"},{"text":"▼ ","color":"green"},{"text":"' + shlStations[i] +'","bold":true,"color":"yellow"},{"text":"&bsol;n"},{"text":"▽ ","color":"green"},{"text":"' + shlStations[i+1] + '","color":"gray"},{"text":"&bsol;n"},{"text":"▽ ","color":"green"},{"text":"' + shlStations[i+2] + '","color":"gray"},{"text":"&bsol;n"}]</textarea></div></br>'
  document.getElementById("upStationList").innerHTML = existingHTML + stationNameHeader + announcementString;
}

for (let i = shlStationCount-1; i > -1; i--) {
  console.log(shlStations[i]);
