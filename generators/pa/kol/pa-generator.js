...
let HOL = {name:"北陸綫 Hokuriku Line", short:"HOL", color:"dark_purple"};
...
let SHC = {name:"深卡城 Shimakaze City", interchange:[SOL,REL,SHL]};
let SHN = {name:"沙草灣 Savanna Bay", interchange:[SOL,SHL]};
...
let OMT = {name:"奄列城 Omelette Town", interchange:[CDL]};
let CHY = {name:"政逸 Ching Yat", interchange:[CSL,CDL]};
let ARA = {name:"荒島 Arashima", interchange:[SOL,HOL]};

//Current Line Info
let lineInfo = KOL;

//Current Station List
let stationArray = [OMT,CHY,SHC,SHN,ARA];
